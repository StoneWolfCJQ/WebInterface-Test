...
可以在本地和远程设备上校验IO的软件  
`注1：目前只支持ACS和三菱系列的PLC，并且需要安装SPiiPlus MMI Application Studio 2.50相应软件及三菱的MX COMPONENT（我用的是4.16）`  
...
***
# Release
[Installer](https://github.com/StoneWolfCJQ/WebInterface-Test/releases)
